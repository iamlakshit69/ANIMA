...
POST_SPEECH_MUTE = 0.3  # seconds to ignore mic after assistant finishes speaking
...
async def microphone_stream():
    ...
    try:
        while True:
            ...
            # immediately because stt.py's BUFFER_MUTE_GUARD would discard the
            # buffer — speaking_ended_at was just stamped.
            ...
            # A time-window approach (~3 frames) can be skipped entirely under
            # load; the flag cannot.
            if mute_was_active:
                silence_chunks  = 0
                speech_frames   = 0
                ...
                # passed. stt.py's BUFFER_MUTE_GUARD will also have elapsed
                # by this point so the buffer won't be discarded there.
                if pending_barge_in:
